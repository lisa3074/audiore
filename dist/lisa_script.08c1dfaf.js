...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"lisa_script.js":[function(require,module,exports) {
...
function menu() {
  ...
  if (navigation) {
    ...
    var genres_menu = document.querySelector(".genres_menu");
    ...
    document.querySelectorAll(".dropdown p, .genres_menu p").forEach(function (x) {
      x.addEventListener("click", function () {
        dropdown.classList.add("hide");
        genres_menu.classList.add("hide");
      });
    });
    document.querySelectorAll(" ul > li:nth-child(6)").forEach(function (li) {
      li.addEventListener("click", function () {
        document.querySelector(".genres_menu").classList.remove("hide");
      });
    });
    document.querySelectorAll(".menu_elements").forEach(function (el) {
  ...
  if (frontpage) {
    ...
    document.querySelector("main").addEventListener("scroll", function () {
      ...
      if (position < 0.01) {
        ...
        document.querySelectorAll(".burger img").forEach(function (img) {
...
function navigation() {
  var index = document.querySelector(".frontpage");
  document.querySelectorAll(".menu_elements").forEach(function (menuEl) {
    menuEl.addEventListener("click", function (e) {
      var target = e.target.getAttribute("data-name");

      if (document.querySelector(target)) {
        document.querySelector("#" + e.target.getAttribute("data-name")).scrollIntoView({
          behavior: "smooth"
        });
      } else {
  ...
  if (index) {
    document.querySelector(".top.all").addEventListener("click", function () {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","lisa_script.js"], null)
//# sourceMappingURL=/lisa_script.08c1dfaf.js.map